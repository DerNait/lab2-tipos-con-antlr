...
def serializedATN():
    return [
        ...
        2,1,2,0,1,4,3,0,2,4,0,2,1,0,1,2,1,0,4,5,48,0,7,1,0,0,0,2,11,1,0,
        ...
        28,29,10,8,0,0,29,30,5,3,0,0,30,38,3,4,2,9,31,32,10,7,0,0,32,33,
            ...
            while _alt!=2 and _alt!=ATN.INVALID_ALT_NUMBER:
                if _alt==1:
                    ...
                    if la_ == 1:
                        ...
                        self.state = 29
                        localctx.op = self.match(SimpleLangParser.T__2)
                        self.state = 30
                        self.expr(9)
                        pass
